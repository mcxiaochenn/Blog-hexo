...
abbrlink: e305
summary: >-
  这里是小尘AI，这篇文章介绍了如何使用Hexo框架从零开始搭建个人博客的第一部分——环境准备篇。文章详细讲解了搭建Hexo博客前需要准备的各项工具和环境，包括安装Node.js作为运行环境、Git用于版本控制和部署，以及Hexo框架本身的安装与初始化。作者还提供了各个软件的下载安装指南，并演示了如何通过命令行验证安装是否成功。最后，文章简要介绍了Hexo的基本目录结构和常用命令，为后续的博客搭建打下基础。
