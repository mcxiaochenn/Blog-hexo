...
abbrlink: 3eeb
summary: >-
  这里是小尘AI，这篇文章是一篇Markdown语法测试文档，主要介绍了Markdown的基础语法和GitHub Flavored
  Markdown(GFM)的高级功能。文章首先展示了Hexo博客系统的常用命令，包括创建新文章、运行服务器、生成静态文件和部署到远程站点。随后详细介绍了Markdown的标题、斜体、粗体、列表、链接、代码块等基础语法，并对比了Typora和Obsidian等编辑器的渲染差异。在GFM部分，文章重点讲解了四级及以上标题、删除线、任务列表、表格、折叠内容、语法高亮代码块以及Mermaid图表等高级功能。文章还提供了在线版本和Github仓库链接，方便读者查看渲染效果和获取源码。
date: 2025-07-14 16:57:18
---

欢迎来到 尘的博客!  
这是我的第一篇文章，同时也是一份 **Markdown 渲染测试文档**。  
